...
vector<long long> vectorproduct(vector<long long> v1, vector<long long> v2){
    ...
    result.push_back((v1[0] * v2[0] + v1[1] * v2[2])%1000000);
    result.push_back((v1[0] * v2[1] + v1[1] * v2[3])%1000000);
    result.push_back((v1[2] * v2[0] + v1[3] * v2[2])%1000000);
    result.push_back((v1[2] * v2[1] + v1[3] * v2[3])%1000000);
    return result;
}
